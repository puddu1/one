...
<body>
    <header>
        <h1>Chandra - DevOps Specialist</h1>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm Chandra, a DevOps Specialist passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
